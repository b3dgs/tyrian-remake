 ...
 */
public final class SingleCanon
        extends EntityScenery
{
    /** Class media. */
    public static final Media MEDIA = Entity.getConfig(CategoryType.SCENERY, SingleCanon.class);

    /**
     * {@link Entity#Entity(SetupSurfaceGame)}
     */
    public SingleCanon(SetupSurfaceGame setup)
    {
        super(setup);
    }
}
