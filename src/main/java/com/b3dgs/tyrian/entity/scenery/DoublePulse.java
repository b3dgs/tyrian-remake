...
{
    /** Class media. */
    public static final Media MEDIA = Entity.getConfig(CategoryType.SCENERY, DoublePulse.class);

    /**
     * {@link Entity#Entity(SetupSurfaceGame)}
     */
    public DoublePulse(SetupSurfaceGame setup)
    {
        super(setup);
    }
}
